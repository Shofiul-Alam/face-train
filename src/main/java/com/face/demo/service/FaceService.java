...
public class FaceService {
    ...
    public static final String storageConnectionString =
            "DefaultEndpointsProtocol=https;"
                    + "AccountName=vaa0storage;"
                    + "AccountKey=vU2zTByMGxI8mmafqvVzMa/Lx/MaQhrHc0pCHfF+url+jeQhiRDFOelTSoxh7jZx9NPgIgjEhz7z8KRNRHYngA==";

    private static final String blobImageContainer = "vaa-blob";
    private static final String unknownBlobImageContainer = "unknowns";

    private static final String faceApikey = "0f302c27cb4a4e90adec9eaf6335b191";
    private static final String apiDomain = "australiaeast.api.cognitive.microsoft.com";
    ...
    public String createPersonGroup(String name) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/persongroups/" + name)
                    .build();
    ...
    public String createPerson(String personGroupId, String name) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/persongroups/" + personGroupName + "/persons")
                    .build();
    ...
    public String addPersonFace(String imageUrl, FaceDTO faceDto) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/persongroups/" + faceDto.getGroupId() + "/persons/" + faceDto.getPersonId() + "/persistedFaces")
    ...
    public String getPerson(String groupId, String personId) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/persongroups/" + groupId + "/persons/" + personId)
                    .build();
    ...
    public String getPersonFaceMetaData(String groupId, String personId, String personFaceId) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/persongroups/" + groupId + "/persons/" + personId + "/persistedFaces/" + personFaceId)
                    .build();
    ...
    public void trainPersonGroup(String personGroupId) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/persongroups/" + personGroupId + "/train")
                    .build();
    ...
    public String detectFace(String imageUrl) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/detect")
    ...
    public String identifyFace(String faceId, String groupId) {
        ...
        try {
            ...
            UriComponents builder = UriComponentsBuilder.newInstance().scheme("https")
                    .host(apiDomain).path("/face/v1.0/identify")
                    .build();
